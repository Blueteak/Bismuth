...
| D-026 | Match the active author-code cubic normalization `1 / [3 (1 + epsilon)^2]`.                                         | The paper's displayed anisotropy omits this factor, while the reference implementation and validated hopper behavior include it.                 |
